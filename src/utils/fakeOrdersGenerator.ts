...
const EXACT_PRESETS = [
  ...
  { sep: 0.0, cc: 190.0, tot: 190.0, cobrado: 190.0, method: 'Yape\nQR BBVA VANTA', status: 'Cobro recibido', images: 3 },
  { sep: 0.0, cc: 99.0, tot: 99.0, cobrado: 99.0, method: 'Plin', status: 'Cobro recibido', images: 2 },
  { sep: 0.0, cc: 69.0, tot: 69.0, cobrado: 69.0, method: 'Efectivo', status: 'Cobro recibido', images: 3 },
  { sep: 0.0, cc: 55.0, tot: 55.0, cobrado: 55.0, method: 'BCP Soles', status: 'Cobro recibido', images: 3 },
  { sep: 0.0, cc: 180.0, tot: 180.0, cobrado: 180.0, method: 'Efectivo\nQR BBVA VANTA', status: 'Cobro recibido', images: 3 },
  { sep: 0.0, cc: 109.0, tot: 109.0, cobrado: 109.0, method: 'Yape', status: 'Cobro recibido', images: 3 },
  { sep: 0.0, cc: 35.0, tot: 35.0, cobrado: 35.0, method: 'Efectivo', status: 'Cobro recibido', images: 2 },
